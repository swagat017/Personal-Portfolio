...
export const personal = {
  ...
  intro:
    "Final-year Computer Engineering student who got hooked on AI/ML through building things, not just reading about them. I like taking a project all the way from messy data to a working result, not stopping once a notebook prints a good accuracy score.",
};
